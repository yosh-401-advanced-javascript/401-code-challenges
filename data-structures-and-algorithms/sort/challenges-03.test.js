...
const sortBackwards = (arr) => arr.sort(function(a, b) {return b - a});
...
const sortByLength = (arr) => arr.sort(function(a, b) {return a.length - b.length});{
  // Solution code here...
};
...
const sortByPrice = (arr) => arr.sort(function(a, b){
a = a.price;
b = b.price;
return a < b ? -1 : a > b ? 1 : 0;
...
const sortNumbersByLength = (arr) => arr.sort(function(a,b) { return a.toString().length - b.toString().length });
...
const sortPeople = (arr) => arr.sort((a,b) => { return a.lastName < b.lastName ? -1 : a.lastName > b.lastName ? 1 : 0;});
